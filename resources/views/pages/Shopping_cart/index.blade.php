        ...
        <div class="col-8">
            ...
            <div class="row">
                <div class="col d-flex id="myPrice">
                    <div class="mr-3" id="newPrice" ><del style="text-decoration: line-through">$' . $price . '</div>
...
<body>
    ...
    <div class="row container-fluid">
        <div class="col-7">
           <center> <div id="title"><i class="fas fa-check-circle pb-3" style="color:green"></i> FREE ground shipping</div></center>
    ...
    <div class="content"style="width: 100; height: 100%; background: #D9D9D9">
                ...
                <div class="col" >
                    <div class="border-line" id="line">
                        ...
                        <div class="newInput">
                            ...
                            <p>Please note: Certain promotions cannot be combined. Please see specific promotion terms and conditions.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="pickUp">
        <center>  <button id="pickup">PICK UP DIRECTLY AT THE STORE </button><center>
        </div>
    </div>
</div>
