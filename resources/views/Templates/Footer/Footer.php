        ...
        <div class="row">
            ...
            <div class="col">
                <div class="c4">
                    ...
                    <div class="text-left">
                        <a href=""><i id="content3" class="fa-solid fa-phone"></i> <label
                                id="icontent">0858776464</label></a><br>
                        <a href=""><i id="content3" class="fa-solid fa-envelope"></i> <label
                                id="icontent">dda@gmail.com</label></a><br>
